...
<html lang="en">
  <head>
    ...
    <title>BCSHS-SAC Search Students</title>
  ...
  <body>
    ...
    <div class="form-group">
        ...
        <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search by Student Class">
    </div>
...
<div class="d-sm-flex align-items-center mb-4">
    ...
    ?>
    <h4 align="center">Result showing "<?php echo $sdata;?>" keyword</h4>
</div>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="font-weight-bold">Student Email Address</th>
        ...
        <tbody>
            ...
            $ret = "SELECT ClassName FROM tblclass WHERE ClassName LIKE :search";
            $query1 = $dbh->prepare($ret);
            $query1->bindParam(':search', $sdata, PDO::PARAM_STR);
            $query1->execute();
            ...
            $sql = "SELECT tblstudent.StuID, tblstudent.ID as sid, tblstudent.StudentName, tblstudent.StudentEmail, tblstudent.DateofAdmission, tblclass.ClassName, tblclass.Section 
                    ...
                    WHERE tblclass.ClassName LIKE :searchData 
                    LIMIT :offset, :no_of_records_per_page";
            $query = $dbh->prepare($sql);
            $query->bindParam(':searchData', $sdata, PDO::PARAM_STR);
